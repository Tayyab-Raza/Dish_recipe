...
const Navbar = () => {
  ...
  return (
    ...
    <nav
      class="top-0 z-10 block w-full max-w-full px-4 py-2 text-black bg-slate-200 bg-transparent border-none focus:outline-none rounded-none h-max bg-opacity-80 backdrop-blur-2xl backdrop-saturate-200 lg:px-8 lg:py-4">
      <div class="flex items-center justify-between text-blue-gray-900">
        ...
        <div class="flex items-center gap-2 ">
          ...
          <BiSearch />
            <input type="text" id='text' placeholder='Search recipe' className='w-full bg-transparent border-none focus:outline-none'/>
            </div>
          <div class="flex items-center gap-x-1">
            ...
            <button
              ...
              type="button" onClick={handleSignupClick}>
              <span >Sign Up</span>
            </button>
          </div>
          <button
