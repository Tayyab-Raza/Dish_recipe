...
const Navbar = () => {
  return (
    <nav class="top-0 z-10 block w-full max-w-full px-4 py-2 text-black bg-slate-100 border-none focus:outline-none rounded-none shadow-md h-max bg-opacity-80 backdrop-blur-2xl backdrop-saturate-200 lg:px-8 lg:py-4">
